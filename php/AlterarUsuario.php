...
if ( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
    ...
    and isset($_POST['tipouser']) ) {
        ...
        $result =  $db->atualizarUsuario($_POST['id'], $_POST['nome'], $_POST['sobrenome'], $_POST['datanascimento'], $_POST['rg'], $_POST['cpf'], $_POST['email'], $_POST['telefone'], $_POST['rua'], $_POST['bairro'], $_POST['cidade'], $_POST['estado'], $_POST['quadra'], $_POST['lote'], $_POST['numero'], $_POST['complemento'], $_POST['senha'], $_POST['csenha'], $_POST['tipouser']);
        if ( $result == 1) {
